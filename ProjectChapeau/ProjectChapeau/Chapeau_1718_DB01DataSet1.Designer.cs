...
namespace ProjectChapeau {
    ...
    public partial class Chapeau_1718_DB01DataSet1 : global::System.Data.DataSet {
        ...
        public partial class EmployeeDataTable : global::System.Data.TypedTableBase<EmployeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public EmployeeRow AddEmployeeRow(string Firstname, string Lastname, string Password, string JobRole, string Username) {
...
namespace ProjectChapeau.Chapeau_1718_DB01DataSet1TableAdapters {
    ...
    public partial class EmployeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@IsNull_JobRole", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "JobRole", global::System.Data.DataRowVersion.Original, true, null, "", "", ""));
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_JobRole", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "JobRole", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Employee] ([Firstname], [Lastname], [Password], [JobRole], [Username]) VALUES (@Firstname, @Lastname, @Password, @JobRole, @Username);
SELECT EmployeeId, Firstname, Lastname, Password, JobRole, Username FROM Employee WHERE (EmployeeId = SCOPE_IDENTITY())";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@JobRole", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "JobRole", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Username", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Username", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employee] SET [Firstname] = @Firstname, [Lastname] = @Lastname, [Password] = @Password, [JobRole] = @JobRole, [Username] = @Username WHERE (([EmployeeId] = @Original_EmployeeId) AND ((@IsNull_Firstname = 1 AND [Firstname] IS NULL) OR ([Firstname] = @Original_Firstname)) AND ((@IsNull_Lastname = 1 AND [Lastname] IS NULL) OR ([Lastname] = @Original_Lastname)) AND ((@IsNull_Password = 1 AND [Password] IS NULL) OR ([Password] = @Original_Password)) AND ((@IsNull_JobRole = 1 AND [JobRole] IS NULL) OR ([JobRole] = @Original_JobRole)) AND ((@IsNull_Username = 1 AND [Username] IS NULL) OR ([Username] = @Original_Username)));
SELECT EmployeeId, Firstname, Lastname, Password, JobRole, Username FROM Employee WHERE (EmployeeId = @EmployeeId)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@JobRole", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "JobRole", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@IsNull_JobRole", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "JobRole", global::System.Data.DataRowVersion.Original, true, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_JobRole", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "JobRole", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT EmployeeId, Firstname, Lastname, Password, JobRole, Username FROM dbo.Empl" +
                "oyee";
        ...
        public virtual int Fill(Chapeau_1718_DB01DataSet1.EmployeeDataTable dataTable) {
        ...
        public virtual Chapeau_1718_DB01DataSet1.EmployeeDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Chapeau_1718_DB01DataSet1.EmployeeDataTable dataTable = new Chapeau_1718_DB01DataSet1.EmployeeDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Chapeau_1718_DB01DataSet1.EmployeeDataTable dataTable) {
        ...
        public virtual int Delete(int Original_EmployeeId, string Original_Firstname, string Original_Lastname, string Original_Password, string Original_JobRole, string Original_Username) {
        ...
        public virtual int Insert(string Firstname, string Lastname, string Password, string JobRole, string Username) {
            if ((Firstname == null)) {
            ...
            if ((JobRole == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[3].Value = ((string)(JobRole));
            }
            if ((Username == null)) {
        ...
        public virtual int Update(string Firstname, string Lastname, string Password, string JobRole, string Username, int Original_EmployeeId, string Original_Firstname, string Original_Lastname, string Original_Password, string Original_JobRole, string Original_Username, int EmployeeId) {
            if ((Firstname == null)) {
            ...
            if ((Original_JobRole == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[13].Value = ((string)(Original_JobRole));
            }
            if ((Original_Username == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Firstname, string Lastname, string Password, string JobRole, string Username, int Original_EmployeeId, string Original_Firstname, string Original_Lastname, string Original_Password, string Original_JobRole, string Original_Username) {
            return this.Update(Firstname, Lastname, Password, JobRole, Username, Original_EmployeeId, Original_Firstname, Original_Lastname, Original_Password, Original_JobRole, Original_Username, Original_EmployeeId);
        }
    }
